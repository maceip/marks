...
class ReleaseRootContract(unittest.TestCase):
    ...
    def test_node_toolchain_is_fixed_root_owned_single_link_content(self):
        ...
        # Explicitly enforce correct permissions across the directory chain
        os.chmod(root, 0o755)
        os.chmod(root / "bin", 0o755)
        os.chmod(root / "lib", 0o755)
        os.chmod(root / "lib" / "node_modules", 0o755)
        os.chmod(root / "lib" / "node_modules" / "npm", 0o755)
        os.chmod(root / "lib" / "node_modules" / "npm" / "bin", 0o755)
